            ...
            <>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                  ...
                  {/* Photos + Documents — AttachmentViewer */}
                  {(photos.length > 0 || pdfs.length > 0) && (
                    <div className="bg-white rounded-[24px] border border-slate-100 shadow-sm p-6">
                ...
                <div className="space-y-6">
                  ...
                  {/* Documents PDF — géré par AttachmentViewer ci-dessus */}
                  ...
                  <div className="space-y-2">
                    {report.ticket_id && (
                      <a href={`/provider/tickets/${report.ticket_id}`}
                        className="flex items-center justify-between px-4 py-3 rounded-2xl border border-slate-200 bg-white hover:bg-slate-50 transition group">
                    ...
                    {report.planning_id && (
                      <a href={`/provider/planning`}
                        className="flex items-center justify-between px-4 py-3 rounded-2xl border border-slate-200 bg-white hover:bg-slate-50 transition group">
                        <span className="text-xs font-bold text-slate-700">Voir le planning lié</span>
                        <ArrowUpRight size={14} className="text-slate-400 group-hover:text-slate-900 transition" />
                      </a>
                    )}
                    <a href="/provider/rapports"
                      className="flex items-center justify-between px-4 py-3 rounded-2xl border border-slate-200 bg-white hover:bg-slate-50 transition group">
                      <span className="text-xs font-bold text-slate-700">Tous mes rapports</span>
                      <ArrowUpRight size={14} className="text-slate-400 group-hover:text-slate-900 transition" />
                    </a>
                  </div>
                </div>
